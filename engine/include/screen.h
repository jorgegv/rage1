...
// Inventory area
#define INVENTORY_TOP		( BORDER_BOTTOM )
#define INVENTORY_BOTTOM	( BORDER_BOTTOM )
#define INVENTORY_LEFT		( BORDER_RIGHT - 6 )
#define INVENTORY_RIGHT		( BORDER_RIGHT - 2)
#define INVENTORY_WIDTH		( INVENTORY_RIGHT - INVENTORY_LEFT + 1 )
#define INVENTORY_HEIGHT	( INVENTORY_BOTTOM - INVENTORY_TOP + 1 )

// Lives area
#define LIVES_AREA_TOP		( BORDER_BOTTOM )
#define LIVES_AREA_BOTTOM	( BORDER_BOTTOM )
#define LIVES_AREA_LEFT		( BORDER_LEFT + 2 )
#define LIVES_AREA_RIGHT	( BORDER_LEFT + 7 )
